...
import { X, User, Loader2, Save, Building2, Shield } from "lucide-react";
...
export default function GlobalUserModal({ isOpen, user, onClose, onSuccess }: GlobalUserModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-surface-lowest rounded-[2.5rem] shadow-ambient overflow-hidden animate-in zoom-in-95 duration-300">
        {/* Header */}
